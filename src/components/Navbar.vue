  ...
  <div class="container-fluid ps-0 bg-light">
    <nav class="navbar" :class="navbarClasses" :style="{ transform: translateY }">
      <div class="container-fluid mx-4">
        <a href="/" class="logo">
          <img src="@/assets/logo1.png" class="float-start m-1 mt-2" alt="..." style="width: 44px" />
        </a>
        ...
        >
          ...
          <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-custom ms-4 px-3 btn-nav">Resume</a>
</div>
      </div>
    </nav>
  </div>
