<template>
	<div class="container-fluid wrapper my-5">
		<div class="d-flex align-items-start flex-column justify-content-center mx-5">
			<div class="header my-5">What I've build</div>
			...
			<div class="project-grid">
				...
				>
					<div class="card-header py-0 my-0">
						<h2 style="color: var(--primary-color)"><i class="far fa-folder"></i></h2>
						<a :href="project.githubLink" target="_blank" class="mb-2">
